...
for (let finger of [fp.Finger.Index, fp.Finger.Thumb,fp.Finger.Middle, fp.Finger.Ring, fp.Finger.Pinky]) {
    ...
    FiveFingerGesture.addDirection(finger, fp.FingerDirection.DiagonalUpLeft, 1.0);
    FiveFingerGesture.addDirection(finger, fp.FingerDirection.DiagonalUpRight, 1.0);

  }


  export default FiveFingerGesture;